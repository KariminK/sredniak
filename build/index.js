...
const filterYearGrade = (el) => el.firstElementChild.textContent === "Ocena roczna";
const extractTextGrade = (el) => el.nextElementSibling.firstElementChild.lastElementChild.textContent.trim();
const convertToNumericGrade = (textGrade) => textGrade in grades ? grades[textGrade] : null;
...
addEventListener("click", () => {
    if (!document.querySelector("#ext-tab-5")?.classList.contains("x-active"))
        return;
    if (document.querySelectorAll(".x-label-el") === null)
        return;
